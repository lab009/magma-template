...
const values = {
  ...
  port: EnvVars.number('PORT', 4000),

  // The port on which the client bundle development server should run.
  clientDevServerPort: EnvVars.number('CLIENT_DEV_PORT', 4100),
  ...
  serviceWorker: {
    ...
    // offline.
    offlinePageTemplate: './config/offlinePageTemplate.js',
